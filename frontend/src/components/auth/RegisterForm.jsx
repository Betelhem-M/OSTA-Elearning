...
export default function RegisterForm() {
  ...
  function handleSubmit(event) {
    ...
    const nextErrors = {
      ...
      terms: agreedToTerms ? '' : 'You must agree to the Terms of Service and Privacy Policy.',
    };
    ...
    <div className="mx-auto w-full max-w-[520px]">
      ...
      <form className="space-y-5" onSubmit={handleSubmit} noValidate>
        ...
        <div>
          ...
          {errors.phone && (
            <span className="mt-1.5 block text-xs font-semibold text-red-600">{errors.phone}</span>
          )}
        </div>
        ...
        <div>
          ...
          {errors.region && (
            <span className="mt-1.5 block text-xs font-semibold text-red-600">{errors.region}</span>
          )}
        </div>
        ...
        <div className="space-y-3">
          ...
          {errors.terms && (
            <span className="block text-xs font-semibold text-red-600">{errors.terms}</span>
          )}
      ...
      <div className="mt-6 flex items-center gap-3">
        ...
        <span className="text-xs font-semibold text-slate-400">Or register with</span>
        <div className="h-px flex-1 bg-slate-200" />
      </div>
