...
export default function SubmissionForm({ assignment, onSubmit }) {
  ...
  function handleSubmit(event) {
    ...
    // No real backend/file storage in this build — simulate a successful submission.
  ...
  return (
    ...
    >
      <h2 className="text-sm font-bold text-ink">Submit Your Work</h2>
      ...
      >
        ...
        <p className="text-xs text-slate-400">
          Accepted: {assignment.allowedFileTypes} · Max{" "}
          {assignment.maxFileSizeMB}MB per file
        </p>
        <input
          ref={inputRef}
          type="file"
      ...
      <button
        type="submit"
        className="mt-5 flex h-12 w-full items-center justify-center rounded-lg bg-primary text-sm font-bold text-white transition hover:bg-primary-hover"
      >
        Submit Assignment
      </button>
    </form>
