  ...
  return (
    <Routes>
      ...
      <Route element={<RoleRoute role="student"><StudentLayout /></RoleRoute>}>
        ...
        <Route path="/questions" element={<PrivateQuestions />} />
      ...
      <Route element={<RoleRoute role="instructor"><InstructorLayout /></RoleRoute>}>
        ...
        <Route path="/instructor/students/:studentId/progress" element={<StudentProgress />} />
        <Route path="/instructor/analytics" element={<InstructorAnalytics />} />
        <Route path="/instructor/assignments" element={<InstructorAssignments />} />
        <Route path="/instructor/assignments/review" element={<AssignmentEvaluation />} />
        <Route path="/instructor/questions" element={<PrivateQuestions />} />
        <Route path="/instructor/events/create" element={<CreateEvent />} />
        <Route path="/instructor/events" element={<EventManagement />} />
        <Route path="/instructor/events/:id/edit" element={<CreateEvent />} />
        <Route path="/instructor/competitions" element={<Competitions />} />
        <Route path="/instructor/settings" element={<PaymentAccounts />} />
      </Route>
